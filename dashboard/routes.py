...
AGENT_META: list[dict] = [
    {"name": "analyzer_agent", "icon": "📈", "stage": "Analyzing the market",
     "description": "Scans the web/Reddit/X/Quora for trends and unmet needs; picks a product to build."},
    ...
    {"name": "planner_agent", "icon": "🗺️", "stage": "Planning the architecture",
     "description": "Turns market + research into a full build plan and acceptance criteria."},
    {"name": "code_builder", "icon": "💻", "stage": "Building the product",
     "description": "Builds the product to the plan, sandbox-tests it, and self-heals."},
    {"name": "product_critic", "icon": "🔬", "stage": "Validating (QA)",
     "description": "Validates against the plan, rates production-readiness, sends back if incomplete."},
    {"name": "marketing_agent", "icon": "📣", "stage": "Marketing the product",
     "description": "Writes launch copy, posts to Telegram, and updates the blog."},
]
# Everything else — shown in the agent grid but not the linear product pipeline.
SIDE_AGENTS: list[dict] = [
    ...
    {"name": "monthly_evaluator", "icon": "📊", "stage": "Evaluating KPIs",
     "description": "Aggregates KPIs and decides CONTINUE / PIVOT / KILL."},
    {"name": "niche_scout", "icon": "🔍", "stage": "Niche discovery (legacy)",
     "description": "Content-mode: scrapes trends and ranks commercial niches."},
    {"name": "legal_researcher", "icon": "⚖️", "stage": "Compliance (legacy)",
     "description": "Content-mode: FTC / EU AI Act / platform rules."},
    {"name": "content_writer", "icon": "✍️", "stage": "Article writing (legacy)",
     "description": "Content-mode: drafts and revises long-form articles."},
    {"name": "content_critic", "icon": "📝", "stage": "Article review (legacy)",
     "description": "Content-mode: scores article drafts 0-100."},
    {"name": "plagiarism_checker", "icon": "🔎", "stage": "Originality (legacy)",
     "description": "Content-mode: originality/plagiarism gate."},
    {"name": "compliance_agent", "icon": "✅", "stage": "Disclosures (legacy)",
     "description": "Content-mode: injects FTC/AI disclosures."},
    {"name": "product_creator", "icon": "📦", "stage": "Ebook building (legacy)",
     "description": "Content-mode: builds ebooks/guides/packs."},
]
